          ...
          <div class="row">
               <div class="col-md-offset-1 col-md-10 col-sm-12">
					...
					<form name="tell" id="tell" method="post" action ="send_mail.php" autocomplete="on">
						...
						<div class="col-md-4 col-sm-4">
							<input type="email" name="mail_mittente" class="form-control" id="email_mittente" placeholder="Email" value = "">
						</div>
						<div class="col-md-4 col-sm-4">
							<input type="text" name="subject" class="form-control" id="subject" placeholder="Subject">
						</div>
  						<div class="col-md-12 col-sm-12">
                             <textarea name="messaggio" rows="10" cols="30" class="form-control" id="message" placeholder="Message"></textarea>
                        </div>
