...
<body>
    ...
    <section id="home" class="main-single-post parallax-section">
        ...
        <div class="col-md-12 col-sm-12" style="-moz-user-select: none; -webkit-user-select: none; -ms-user-select:none; user-select:none;-o-user-select:none;"
            ...
            <p>
                <h3>"It was so exciting to go to the record shop and buy a piece of vinyl and hold it, read the liner
                    notes, look at the pictures. Even the smell of the vinyl."
            </p>Martin Gore</h3>
    </section>
