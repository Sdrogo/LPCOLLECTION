...
<title>LP Collection - Inserisci nuovo Gruppo</title>
     ...
     <div class="container">
          ...
          <div class="collapse navbar-collapse">
               <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="inserisciGruppo">Insert Band</a></li>
...
<section id="home" class="main-single-post parallax-section">
     <div class="overlay"></div>
        ...
        <h1>Inserisci nuovo Gruppo</h1>
        <p><h3>"It was so exciting to go to the record shop and buy a piece of vinyl and hold it, read the liner notes, look at the pictures. Even the smell of the vinyl." </p>Martin Gore</h3>		
</section>
...
<script>    
    ...
    reader.addEventListener("load", function () {
        ...
        document.getElementById('url_photo').value = reader.result;
    }, false);
    if (file) {
